...
namespace Rhetos.Dom.DefaultConcepts
{
    ...
    [ExportMetadata(MefProvider.Implements, typeof(InvalidDataMessageParametersConstantInfo))]
    public class InvalidDataMessageParametersConstantCodeGenerator : IConceptCodeGenerator
    {
