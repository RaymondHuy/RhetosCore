...
namespace Rhetos.Dom.DefaultConcepts
{
    ...
    [ExportMetadata(MefProvider.Implements, typeof(RowPermissionsRuleDenyWriteInfo))]
    public class RowPermissionsRuleDenyWriteCodeGenerator : IConceptCodeGenerator
    {
