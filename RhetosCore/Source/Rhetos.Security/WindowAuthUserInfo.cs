...
namespace Rhetos.Security
{
    public class WindowAuthUserInfo : IWindowsUserInfo
    {
        ...
        public WindowAuthUserInfo(ILogProvider logProvider, IWindowsSecurity windowsSecurity, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            _logger.Trace(() => "HttpContext.Current.User.Identity: " + Report((WindowsIdentity)_httpContextAccessor.HttpContext.User.Identity));
            ...
            {
                var windowsIdentity = (WindowsIdentity)_httpContextAccessor.HttpContext.User.Identity;
