...
namespace Rhetos.Processing
{
    ...
    {
        IBasicData<T> CreateBasicData<T>(T value);
        IDataArray CreateDataArray<T>(Type type, T[] data) where T : class;
        IDataArray CreateDomainDataArray(string domainType);
    }

    public static class DataTypeProviderHelper
    {
