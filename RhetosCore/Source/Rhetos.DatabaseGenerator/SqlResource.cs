...
namespace Rhetos.DatabaseGenerator
{
    public class SqlResource
    {
        ...
        public SqlResource(SqlUtility sqlUtility)
        {
        ...
        private ResourceManager ResourceManager
        {
            get
            {
                ...
                {
                    string resourceName = typeof(SqlUtility).Namespace + ".Sql." + _sqlUtility.DatabaseLanguage;
                    var resourceAssembly = typeof(SqlResource).Assembly;
