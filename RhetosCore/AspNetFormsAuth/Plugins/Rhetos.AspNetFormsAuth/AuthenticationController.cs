...
namespace Rhetos.AspNetFormsAuth
{
    ...
    public class AuthenticationController : Controller
    {
        ...
        private void CheckPermissions(Rhetos.Security.Claim claim)
        {
        ...
        [HttpPost("api/GeneratePasswordResetToken")]
        ...
        [HttpPost("api/SendPasswordResetToken")]
